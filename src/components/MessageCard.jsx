...
function MessageCard({ isActive }) {
  ...
  const message = `
  Happiest Birthday, my dear Anushka ❤️
Aur pyaar se Anu — bas, aur koi naam nahi.
Pata nahi yaar, kitne bure-bure naam diye hain tumhe… marshmallow, BumbleBee 😥
Par finally, I got my constant — the only person jiske liye main kuch bhi kar sakta hoon.

Main hamesha tumhe khush dekhna chahta hoon, kyunki
“You happy, I haapppy.” 💛

Thank you, tumne meri har galti ke liye mujhe maaf kiya.
Galtiyaan toh bohot ki hain maine — sach mein —
par tumne har baar maaf kar diya.
Bad student jo kehti ho na tum 😅
ek thappad mein sab samajh aa jaata —
lagta hai woh thappad really pending hai…
aur honestly, tumhara poora haqq banta hai.

Tumhara roothna bhi haqq hai,
aur humein tumhe manana bhi aata hai.
Par sach kahoon —
tum roothi hui bilkul achhi nahi lagti.
Us waqt kahin mann hi nahi lagta,
...
aur har situation mein mere saath khade rehne ke liye,
by my side always.
— main tumhare saath hoon, hamesha aur hamesha ke liye. ❤️✨
